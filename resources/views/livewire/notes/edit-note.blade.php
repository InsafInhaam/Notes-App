    ...
    <div class="max-w-2xl mx-auto space-y-4 sm:px-6 lg:px-8">
        <form wire:submit='saveNote' class="space-y-4">
            ...
            <div class="flex justify-between pt-4">
                <x-button type="submit" class="bg-slate-500" secondary spinner="saveNote">Save Note</x-button>
                <x-button href="{{ route('notes.index') }}" class="border border-solid border-slate-500 text-slate-500" flat negative>Back to Notes</x-button>
            </div>
